...
export default function InvoiceAllocationTabClean() {
  ...
  const handleScan = (data: any) => {
    ...
    if (data.items && data.items.length > 0) {
      const mappedItems = data.items.map((item: any) => {
        const productName = (item.product_service || item.product_name || '').toUpperCase()
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-[140px_1fr] gap-4 items-center border-b border-gray-700 pb-2">
                    ...
                    <MinimalDatePicker
                      ...
                      name="date"
                      required
                      onChange={(e: any) => handleChange({ target: { name: 'date', value: e.target.value } } as any)}
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-[140px_1fr] gap-4 items-center border-b border-gray-700 pb-2">
                    ...
                    <MinimalDatePicker
                      value={form.due_date}
                      name="due_date"
                      onChange={(e: any) => handleChange({ target: { name: 'due_date', value: e.target.value } } as any)}
                    />
                  </div>
